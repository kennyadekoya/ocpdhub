...
def individualdatareport():
    ...
    return render_template("singlestudentresultspage.html", Opportunity = Opportunity , fname = fname, semester = semester, lname = lname, fisk_email=fisk_email, grade=grade.title(), year=year, company_name=company_name, pay=pay, position=position.title())
